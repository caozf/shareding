package com.zhumeng.spring_boot_mybatis_sharding_jdbc.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.zhumeng.spring_boot_mybatis_sharding_jdbc.mapper", sqlSessionTemplateRef  = "test1SqlSessionTemplate")
